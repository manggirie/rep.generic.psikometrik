...
{
    public partial class KementerianController : System.Web.Mvc.Controller
    {
        //exec:Search
        public async Task<System.Web.Mvc.ActionResult> Search()
        {
            ...
            var url = "epsikologi/kementerian/_search";
        ...
        //exec:Save
        public async Task<System.Web.Mvc.ActionResult> Save([RequestBody]Kementerian item)
        {
            ...
            this.Response.ContentType = "application/json; charset=utf-8";
            return Json(new { success = true, status = "OK", id = item.Id, href = "kementerian/" + item.Id });
        }
        //exec:validate
        [HttpPost]
        public async Task<System.Web.Mvc.ActionResult> Validate(string id, [RequestBody]Kementerian item)
        {
            var context = new Bespoke.Sph.Domain.SphDataContext();
            if (null == item) throw new ArgumentNullException("item");
            var ed = await context.LoadOneAsync<EntityDefinition>(d => d.Name == "Kementerian");
        ...
        public async Task<System.Web.Mvc.ActionResult> Remove(string id)
        {
            ...
            var repos = ObjectBuilder.GetObject<IRepository<Kementerian>>();
        ...
        public async Task<System.Web.Mvc.ActionResult> Schemas()
        {
            ...
            var ed = await context.LoadOneAsync<EntityDefinition>(t => t.Name == "Kementerian");
