...
function(context, logger, router, chart, config) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            ...
            var edQuery = String.format("Name eq '{0}'", 'IbkRecommendation'),
                tcs = new $.Deferred(),
                formsQuery = String.format("EntityDefinitionId eq 'ibkrecommendation' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                viewQuery = String.format("EntityDefinitionId eq 'ibkrecommendation'"),
        ...
        chartSeriesClick = function(e) {
            ...
            context.searchAsync("IbkRecommendation", q)
                .done(function(lo) {
        ...
        attached = function(view) {
            chart.init("IbkRecommendation", query, chartSeriesClick, "4c927df4-cef1-40ba-98fc-8cd80c5fb0c2");
        },
