...
function(context, logger, router) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            var query = String.format("Name eq '{0}'", 'UkbpRecommendation'),
                tcs = new $.Deferred(),
                chartsQuery = String.format("Entity eq 'UkbpRecommendation' and IsDashboardItem eq 1"),
                ...
                reportTask = context.loadAsync("ReportDefinition", "[DataSource.EntityName] eq 'UkbpRecommendation'"),
                viewsTask = $.get("/Sph/EntityView/Dashboard/UkbpRecommendation");
