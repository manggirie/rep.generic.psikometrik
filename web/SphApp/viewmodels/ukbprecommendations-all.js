...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config, "partial/ukbprecommendations-all"],
...
function(context, logger, router, chart, config, partial) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            ...
            var edQuery = String.format("Name eq '{0}'", 'UkbpRecommendation'),
                tcs = new $.Deferred(),
                formsQuery = String.format("EntityDefinitionId eq 'ukbprecommendation' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                viewQuery = String.format("EntityDefinitionId eq 'ukbprecommendation'"),
        ...
        chartSeriesClick = function(e) {
            ...
            context.searchAsync("UkbpRecommendation", q)
                .done(function(lo) {
        ...
        attached = function(view) {
            chart.init("UkbpRecommendation", query, chartSeriesClick, "46899330-78c7-4089-849f-2d691d00887d");
