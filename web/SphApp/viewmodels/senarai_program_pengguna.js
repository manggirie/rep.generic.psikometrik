...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config , "partial/senarai_program_pengguna"],
        ...
        var isBusy = ko.observable(false),
            ...
            activate = function () {
               ...
               "bool": {
                ...
                var edQuery = String.format("Name eq '{0}'", 'PendaftaranProgram'),
                  tcs = new $.Deferred(),
                  formsQuery = String.format("EntityDefinitionId eq 'pendaftaranprogram' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                  viewQuery = String.format("EntityDefinitionId eq 'pendaftaranprogram'"),
            ...
            chartSeriesClick = function(e) {
                ...
                context.searchAsync("PendaftaranProgram", q)
                    .done(function (lo) {
