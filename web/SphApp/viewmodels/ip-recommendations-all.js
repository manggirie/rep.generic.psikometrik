...
function(context, logger, router, chart, config) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            ...
            var edQuery = String.format("Name eq '{0}'", 'IpRecommendation'),
                tcs = new $.Deferred(),
                formsQuery = String.format("EntityDefinitionId eq 'iprecommendation' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                viewQuery = String.format("EntityDefinitionId eq 'iprecommendation'"),
        ...
        chartSeriesClick = function(e) {
            ...
            context.searchAsync("IpRecommendation", q)
                .done(function(lo) {
        ...
        attached = function(view) {
            chart.init("IpRecommendation", query, chartSeriesClick, "32099fec-541d-4092-ba8e-0548a320b30a");
        },
