...
function(context, logger, router) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            var query = String.format("Name eq '{0}'", 'SkorIPU'),
                tcs = new $.Deferred(),
                chartsQuery = String.format("Entity eq 'SkorIPU' and IsDashboardItem eq 1"),
                ...
                reportTask = context.loadAsync("ReportDefinition", "[DataSource.EntityName] eq 'SkorIPU'"),
                viewsTask = $.get("/Sph/EntityView/Dashboard/SkorIPU");
