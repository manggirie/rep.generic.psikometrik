...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config, "partial/permohonan-telah-selesai-urusetia-copy"],
...
function(context, logger, router, chart, config, partial) {
    ...
    var isBusy = ko.observable(false),
                        ...
                        "filter": {
                            "bool": {
                                "must": [{
                                    ...
                                    "range": {
                                        "TarikhTamat": {
                                            "to": "2016-07-19T00:00:00.0000000"
                                        }
                                    }
                                }
        ...
        attached = function(view) {
            chart.init("Permohonan", query, chartSeriesClick, "permohonan-permohonan-telah-selesai-urusetia-copy");
