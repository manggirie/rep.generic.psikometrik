...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config , "partial/listprogram"],
    function (context, logger, router, chart,config , partial) {
        ...
        var isBusy = ko.observable(false),
            ...
            attached = function (view) {
                chart.init("permohonan", query, chartSeriesClick, "listprogram");
