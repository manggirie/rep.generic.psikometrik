...
function(context, logger, router, chart, config) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            ...
            var edQuery = String.format("Name eq '{0}'", 'IpuPercentileNorms'),
                tcs = new $.Deferred(),
                formsQuery = String.format("EntityDefinitionId eq 'ipupercentilenorms' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                viewQuery = String.format("EntityDefinitionId eq 'ipupercentilenorms'"),
        ...
        chartSeriesClick = function(e) {
            ...
            context.searchAsync("IpuPercentileNorms", q)
                .done(function(lo) {
        ...
        attached = function(view) {
            chart.init("IpuPercentileNorms", query, chartSeriesClick, "ipupercentilenorms-ipu-percentile-norms-lelaki");
        },
