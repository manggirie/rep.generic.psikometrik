            ...
            var entity = ko.observable(new bespoke.epsikologi_ipurecommendation.domain.IpuRecommendation({WebId:system.guid()})),
                ...
                activate = function (entityId) {
                    ...
                    var query = String.format("Id eq '{0}'", entityId),
                        ...
                        formTask = context.loadOneAsync("EntityForm", "Route eq 'ipu-recommendation-view'"),
                        watcherTask = watcher.getIsWatchingAsync("IpuRecommendation", entityId),
                        i18nTask = $.getJSON("i18n/" + config.lang + "/ipu-recommendation-view");
                ...
                attached = function (view) {
                    // validation
                    validation.init($('#ipu-recommendation-view-form'), form());
                ...
                compositionComplete = function() {
                    ...
                    return context.post(data, "/IpuRecommendation/Save")
                        .then(function(result) {
                            entity().Id(result.id);
                            app.showMessage("Your IpuRecommendation has been successfully saved", "epsikologi", ["OK"]);
