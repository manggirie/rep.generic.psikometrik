...
function(context, logger, router, chart, config) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            ...
            var edQuery = String.format("Name eq '{0}'", 'SkorPpkpProfil'),
                tcs = new $.Deferred(),
                formsQuery = String.format("EntityDefinitionId eq 'skorppkpprofil' and IsPublished eq true and IsAllowedNewItem eq true"),
                viewQuery = String.format("EntityDefinitionId eq 'skorppkpprofil'"),
        ...
        chartSeriesClick = function(e) {
            ...
            context.searchAsync("SkorPpkpProfil", q)
                .done(function(lo) {
        ...
        attached = function(view) {
            chart.init("SkorPpkpProfil", query, chartSeriesClick, "skor-ppkp-profil-all");
        },
