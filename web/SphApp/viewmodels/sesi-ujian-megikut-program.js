...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config, "partial/sesi-ujian-megikut-program"],
...
function(context, logger, router, chart, config, partial) {
    ...
    var isBusy = ko.observable(false),
        ...
        attached = function(view) {
            chart.init("SesiUjian", query, chartSeriesClick, "sesiujian-sesi-ujian-megikut-program");
