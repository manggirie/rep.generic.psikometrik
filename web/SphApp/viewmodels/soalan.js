...
define(['services/datacontext', 'services/logger', 'plugins/router'],
    function (context, logger, router) {
        ...
        var isBusy = ko.observable(false),
            ...
            activate = function () {
                var query = String.format("Name eq '{0}'", 'Soalan'),
                  tcs = new $.Deferred(),
                  chartsQuery = String.format("Entity eq 'Soalan' and IsDashboardItem eq 1"),
                  ...
                  reportTask = context.loadAsync("ReportDefinition", "[DataSource.EntityName] eq 'Soalan'"),
                  viewsTask = $.get("/Sph/EntityView/Dashboard/Soalan");
