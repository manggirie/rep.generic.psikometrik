    ...
    define([objectbuilders.datacontext, objectbuilders.logger, objectbuilders.router,
        ...
        objectbuilders.app ,'partial/permohonan-urusetia-baru'],
            ...
            var entity = ko.observable(new bespoke.epsikologi_permohonan.domain.Permohonan({WebId:system.guid()})),
                ...
                activate = function (entityId) {
                    ...
                    var query = String.format("Id eq '{0}'", entityId),
                        ...
                        formTask = context.loadOneAsync("EntityForm", "Route eq 'permohonan-urusetia-baru'"),
                        watcherTask = watcher.getIsWatchingAsync("Permohonan", entityId),
                        i18nTask = $.getJSON("i18n/" + config.lang + "/permohonan-urusetia-baru");
                ...
                attached = function (view) {
                    // validation
                    validation.init($('#permohonan-urusetia-baru-form'), form());
