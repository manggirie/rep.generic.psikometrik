        ...
        var isBusy = ko.observable(false),
            ...
            activate = function () {
               ...
               "bool": {
                ...
                var edQuery = String.format("Name eq '{0}'", 'HlpRecomendation'),
                  tcs = new $.Deferred(),
                  formsQuery = String.format("EntityDefinitionId eq 'hlprecomendation' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                  viewQuery = String.format("EntityDefinitionId eq 'hlprecomendation'"),
            ...
            chartSeriesClick = function(e) {
                ...
                context.searchAsync("HlpRecomendation", q)
                    .done(function (lo) {
            ...
            attached = function (view) {
                chart.init("HlpRecomendation", query, chartSeriesClick, "3aa1f4d1-a69b-4baf-818f-9711a7088aa1");
            },
