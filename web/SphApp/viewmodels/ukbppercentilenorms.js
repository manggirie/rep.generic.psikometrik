...
function(context, logger, router) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            var query = String.format("Name eq '{0}'", 'UkbpPercentileNorms'),
                tcs = new $.Deferred(),
                chartsQuery = String.format("Entity eq 'UkbpPercentileNorms' and IsDashboardItem eq 1"),
                ...
                reportTask = context.loadAsync("ReportDefinition", "[DataSource.EntityName] eq 'UkbpPercentileNorms'"),
                viewsTask = $.get("/Sph/EntityView/Dashboard/UkbpPercentileNorms");
