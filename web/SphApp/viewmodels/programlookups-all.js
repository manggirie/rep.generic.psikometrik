...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config , "partial/programlookups-all"],
        ...
        var isBusy = ko.observable(false),
            ...
            activate = function () {
               ...
               "bool": {
                ...
                var edQuery = String.format("Name eq '{0}'", 'ProgramLookup'),
                  tcs = new $.Deferred(),
                  formsQuery = String.format("EntityDefinitionId eq 'programlookup' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                  viewQuery = String.format("EntityDefinitionId eq 'programlookup'"),
            ...
            chartSeriesClick = function(e) {
                ...
                context.searchAsync("ProgramLookup", q)
                    .done(function (lo) {
            ...
            attached = function (view) {
                chart.init("ProgramLookup", query, chartSeriesClick, "92b08990-ded6-4e0b-87c3-291e71c7ce9e");
