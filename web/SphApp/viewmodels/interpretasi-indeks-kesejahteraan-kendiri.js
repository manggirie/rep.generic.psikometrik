...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config, "partial/interpretasi-indeks-kesejahteraan-kendiri"],
...
function(context, logger, router, chart, config, partial) {
    ...
    var isBusy = ko.observable(false),
                    ...
                    "filtered": {
                        "filter": {
                            "bool": {
                                "must": [{
                                    "term": {
                                        "NamaUjian": "Indeks Kesejahteraan Kendiri (8-i2K)"
                                    }
                                }
        ...
        attached = function(view) {
            chart.init("Soalan", query, chartSeriesClick, "soalan-interpretasi-indeks-kesejahteraan-kendiri");
