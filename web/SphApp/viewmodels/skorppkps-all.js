...
function(context, logger, router, chart, config) {
    ...
    var isBusy = ko.observable(false),
        ...
        chartSeriesClick = function(e) {
            ...
            context.searchAsync("SkorPpkp", q)
                .done(function(lo) {
        ...
        attached = function(view) {
            chart.init("SkorPpkp", query, chartSeriesClick, "1e681d50-e8c7-4fe0-8497-143c7852997b");
        },
