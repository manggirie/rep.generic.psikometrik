            ...
            var entity = ko.observable(new bespoke.epsikologi_pengguna.domain.Pengguna({WebId:system.guid()})),
                ...
                activate = function (entityId) {
                    ...
                    var query = String.format("Id eq '{0}'", entityId),
                        ...
                        formTask = context.loadOneAsync("EntityForm", "Route eq 'penggunabackup'"),
                        watcherTask = watcher.getIsWatchingAsync("Pengguna", entityId),
                        i18nTask = $.getJSON("i18n/" + config.lang + "/penggunabackup");
                ...
                attached = function (view) {
                    // validation
                    validation.init($('#penggunabackup-form'), form());
