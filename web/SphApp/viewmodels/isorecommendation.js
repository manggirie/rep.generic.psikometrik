...
function(context, logger, router) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            var query = String.format("Name eq '{0}'", 'IsoRecommendation'),
                tcs = new $.Deferred(),
                chartsQuery = String.format("Entity eq 'IsoRecommendation' and IsDashboardItem eq 1"),
                ...
                reportTask = context.loadAsync("ReportDefinition", "[DataSource.EntityName] eq 'IsoRecommendation'"),
                viewsTask = $.get("/Sph/EntityView/Dashboard/IsoRecommendation");
