...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config, "partial/soalan-indikator-personaliti-enneagram"],
...
function(context, logger, router, chart, config, partial) {
    ...
    var isBusy = ko.observable(false),
        ...
        attached = function(view) {
            chart.init("Soalan", query, chartSeriesClick, "soalan-indikator-personaliti-enneagram");
