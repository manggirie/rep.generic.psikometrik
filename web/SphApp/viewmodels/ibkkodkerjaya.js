...
function(context, logger, router) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            var query = String.format("Name eq '{0}'", 'IbkKodKerjaya'),
                tcs = new $.Deferred(),
                chartsQuery = String.format("Entity eq 'IbkKodKerjaya' and IsDashboardItem eq 1"),
                formsQuery = String.format("EntityDefinitionId eq 'ibkkodkerjaya' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                ...
                reportTask = context.loadAsync("ReportDefinition", "[DataSource.EntityName] eq 'IbkKodKerjaya'"),
                viewsTask = $.get("/Sph/EntityView/Dashboard/IbkKodKerjaya");
