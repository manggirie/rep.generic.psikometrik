...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config, "partial/i2krecommendation-all"],
...
function(context, logger, router, chart, config, partial) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            ...
            var edQuery = String.format("Name eq '{0}'", 'I2kRecommendation'),
                tcs = new $.Deferred(),
                formsQuery = String.format("EntityDefinitionId eq 'i2krecommendation' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                viewQuery = String.format("EntityDefinitionId eq 'i2krecommendation'"),
        ...
        chartSeriesClick = function(e) {
            ...
            context.searchAsync("I2kRecommendation", q)
                .done(function(lo) {
        ...
        attached = function(view) {
            chart.init("I2kRecommendation", query, chartSeriesClick, "b6572039-a96f-4694-a800-59463d38dc7d");
