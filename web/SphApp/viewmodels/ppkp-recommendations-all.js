...
function(context, logger, router, chart, config) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            ...
            var edQuery = String.format("Name eq '{0}'", 'PpkpRecommendation'),
                tcs = new $.Deferred(),
                formsQuery = String.format("EntityDefinitionId eq 'ppkprecommendation' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                viewQuery = String.format("EntityDefinitionId eq 'ppkprecommendation'"),
        ...
        chartSeriesClick = function(e) {
            ...
            context.searchAsync("PpkpRecommendation", q)
                .done(function(lo) {
        ...
        attached = function(view) {
            chart.init("PpkpRecommendation", query, chartSeriesClick, "4b1865c5-69fe-4844-9378-72e33732f2a2");
        },
