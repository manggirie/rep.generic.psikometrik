    ...
    function (context, logger, router, chart,config ) {
        ...
        var isBusy = ko.observable(false),
            ...
            chartSeriesClick = function(e) {
                ...
                context.searchAsync("Kementerian", q)
                    .done(function (lo) {
            ...
            attached = function (view) {
                chart.init("Kementerian", query, chartSeriesClick, "44facd30-93b1-40f9-bc12-34968afd3b98");
            },
