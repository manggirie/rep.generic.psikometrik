    ...
    function (context, logger, router, chart,config ) {
        ...
        var isBusy = ko.observable(false),
            ...
            activate = function () {
               ...
               "bool": {
                  ...
                  "must_not": [
                    ...
                    "sort" : [{"UjianNo":{"order":"asc"}}]
                });
                var edQuery = String.format("Name eq '{0}'", 'Ujian'),
                  tcs = new $.Deferred(),
                  formsQuery = String.format("EntityDefinitionId eq 'ujian' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                  viewQuery = String.format("EntityDefinitionId eq 'ujian'"),
            ...
            attached = function (view) {
                chart.init("Ujian", query, chartSeriesClick, "1380e221-a009-4a54-88d2-d59e4f29c0fb");
            },
