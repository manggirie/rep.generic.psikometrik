...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config, "partial/isorecommendations-all"],
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            ...
            var edQuery = String.format("Name eq '{0}'", 'IsoRecommendation'),
                tcs = new $.Deferred(),
                formsQuery = String.format("EntityDefinitionId eq 'isorecommendation' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                viewQuery = String.format("EntityDefinitionId eq 'isorecommendation'"),
        ...
        chartSeriesClick = function(e) {
            ...
            context.searchAsync("IsoRecommendation", q)
                .done(function(lo) {
        ...
        attached = function(view) {
            chart.init("IsoRecommendation", query, chartSeriesClick, "c559279f-c7b0-4a1a-92c1-15a8212d62ce");
