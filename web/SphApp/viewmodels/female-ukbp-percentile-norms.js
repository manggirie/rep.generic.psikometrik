...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config, "partial/female-ukbp-percentile-norms"],
...
function(context, logger, router, chart, config, partial) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            ...
            var edQuery = String.format("Name eq '{0}'", 'UkbpPercentileNorms'),
                tcs = new $.Deferred(),
                formsQuery = String.format("EntityDefinitionId eq 'ukbppercentilenorms' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                viewQuery = String.format("EntityDefinitionId eq 'ukbppercentilenorms'"),
        ...
        chartSeriesClick = function(e) {
            ...
            context.searchAsync("UkbpPercentileNorms", q)
                .done(function(lo) {
        ...
        attached = function(view) {
            chart.init("UkbpPercentileNorms", query, chartSeriesClick, "ukbppercentilenorms-female-ukbp-percentile-norms");
