...
function(context, logger, router) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            var query = String.format("Name eq '{0}'", 'IpRecommendation'),
                tcs = new $.Deferred(),
                chartsQuery = String.format("Entity eq 'IpRecommendation' and IsDashboardItem eq 1"),
                formsQuery = String.format("EntityDefinitionId eq 'iprecommendation' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                ...
                reportTask = context.loadAsync("ReportDefinition", "[DataSource.EntityName] eq 'IpRecommendation'"),
                viewsTask = $.get("/Sph/EntityView/Dashboard/IpRecommendation");
