...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config, "partial/ukbp percentilenorms-all"],
...
function(context, logger, router, chart, config, partial) {
    ...
    var isBusy = ko.observable(false),
        ...
        attached = function(view) {
            chart.init("UkbpPercentileNorms", query, chartSeriesClick, "2dda0da9-9a79-43e3-87ec-93a80c38ebb5");
