...
function(context, logger, router) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            var query = String.format("Name eq '{0}'", 'SkorPpkpProfil'),
                tcs = new $.Deferred(),
                chartsQuery = String.format("Entity eq 'SkorPpkpProfil' and IsDashboardItem eq 1"),
                formsQuery = String.format("EntityDefinitionId eq 'skorppkpprofil' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                ...
                reportTask = context.loadAsync("ReportDefinition", "[DataSource.EntityName] eq 'SkorPpkpProfil'"),
                viewsTask = $.get("/Sph/EntityView/Dashboard/SkorPpkpProfil");
