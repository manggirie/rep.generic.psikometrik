...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config , "partial/permohonans-all"],
    function (context, logger, router, chart,config , partial) {
        ...
        var isBusy = ko.observable(false),
            ...
            attached = function (view) {
                chart.init("Permohonan", query, chartSeriesClick, "9d3f6c7e-bd01-4847-85a2-f5130b960249");
