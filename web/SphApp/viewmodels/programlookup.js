...
define(['services/datacontext', 'services/logger', 'plugins/router'],
    function (context, logger, router) {
        ...
        var isBusy = ko.observable(false),
            ...
            activate = function () {
                var query = String.format("Name eq '{0}'", 'ProgramLookup'),
                  tcs = new $.Deferred(),
                  chartsQuery = String.format("Entity eq 'ProgramLookup' and IsDashboardItem eq 1"),
                  ...
                  reportTask = context.loadAsync("ReportDefinition", "[DataSource.EntityName] eq 'ProgramLookup'"),
                  viewsTask = $.get("/Sph/EntityView/Dashboard/ProgramLookup");
