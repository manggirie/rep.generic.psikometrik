...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config, "partial/skor-ipu-all"],
...
function(context, logger, router, chart, config, partial) {
    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            ...
            var edQuery = String.format("Name eq '{0}'", 'SkorIPU'),
                tcs = new $.Deferred(),
                formsQuery = String.format("EntityDefinitionId eq 'skoripu' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                viewQuery = String.format("EntityDefinitionId eq 'skoripu'"),
        ...
        attached = function(view) {
            chart.init("SkorIPU", query, chartSeriesClick, "65ff0a47-031a-45f6-98a3-0cbf90d8c737");
