    ...
    function (context, logger, router, chart,config ) {
        ...
        var isBusy = ko.observable(false),
            ...
            activate = function () {
               ...
               "bool": {
                  ...
                  "must_not": [
                    ...
                    "sort" : [{"Tarikh":{"order":"desc"}}]
                });
                var edQuery = String.format("Name eq '{0}'", 'PercubaanSesi'),
                  tcs = new $.Deferred(),
                  formsQuery = String.format("EntityDefinitionId eq 'percubaansesi' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                  viewQuery = String.format("EntityDefinitionId eq 'percubaansesi'"),
            ...
            chartSeriesClick = function(e) {
                ...
                context.searchAsync("PercubaanSesi", q)
                    .done(function (lo) {
            ...
            attached = function (view) {
                chart.init("PercubaanSesi", query, chartSeriesClick, "cbc7b866-2b84-4615-a3b3-d232b1b11f54");
            },
