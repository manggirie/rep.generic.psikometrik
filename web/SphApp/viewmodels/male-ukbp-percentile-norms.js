...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config, "partial/male-ukbp-percentile-norms"],
...
function(context, logger, router, chart, config, partial) {
    ...
    var isBusy = ko.observable(false),
        ...
        attached = function(view) {
            chart.init("UkbpPercentileNorms", query, chartSeriesClick, "ukbppercentilenorms-male-ukbp-percentile-norms");
