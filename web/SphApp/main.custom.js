...
(function() {(function(p){var s=this||(0,eval)("this"),v=s.document,L=s.navigator,w=s.jQuery,D=s.JSON;(function(p){"function"===typeof require&&"object"===typeof exports&&"object"===typeof module?p(module.exports||exports,require):"function"===typeof define&&define.amd?define('durandal/knockout', ["exports","require"],p):p(s.ko={})})(function(M,N){function H(a,d){return null===a||typeof a in R?a===d:!1}function S(a,d){var c;return function(){c||(c=setTimeout(function(){c=p;a()},d))}}function T(a,d){var c;return function(){clearTimeout(c);
...
define('viewmodels/messages', [objectbuilders.datacontext, objectbuilders.config],
                ...
                context.loadOneAsync("EntityDefinition", query)
                    .done(function (b) {
                        ...
                        context.loadOneAsync("EntityForm", query2)
                            .done(function (f) {
                                window.location = String.format("/epsikologi#{0}/{1}", f.Route(), sr.id);
                                tcs.resolve(true);
                            });
                    });
        ...
        var activate = function () {
            ...
            attached = function (view) {
                ...
                $(view).on("click", "#drawer-menu", function (e) {
                    sliderVisible = $("#slider-menu").is(":visible");
                    e.preventDefault();
                    if (sliderVisible) {
                        hideSlider();
                    } else {
