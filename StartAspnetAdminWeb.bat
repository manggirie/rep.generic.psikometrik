start "C:\Program Files\Internet Explorer\iexplore.exe" "http://localhost:4437/asp.netwebadminfiles/default.aspx?applicationPhysicalPath=C:\project\rep.generic.psikometrik\web&applicationUrl=/"
