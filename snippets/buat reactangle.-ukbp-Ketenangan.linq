...
petaks.Add(6, new Tuple<Brush,Brush>(Brushes.LightGreen, Brushes.Black));
petaks.Add(7, new Tuple<Brush,Brush>(Brushes.LightGreen, Brushes.Black));
...
petaks.Add(11, new Tuple<Brush,Brush>(Brushes.LightYellow, Brushes.Black));
petaks.Add(12, new Tuple<Brush,Brush>(Brushes.LightYellow, Brushes.Black));
...
petaks.Add(17, new Tuple<Brush, Brush>(Brushes.LightYellow, Brushes.Black));
...
foreach (var k in petaks.Keys)
{
	...
	bmp.Save($@"C:\project\rep.generic.psikometrik\web\images\ukbp\ketenangan-{k * 5}.png", ImageFormat.Png);
